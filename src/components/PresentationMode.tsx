...
export function PresentationMode({ spec, initialSlide, onClose }: {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 9999, background: 'var(--bg, #08080f)', display: 'flex', flexDirection: 'column', fontFamily: 'Inter, sans-serif' }}>
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
        <div style={{ width: '100%', maxWidth: 1280, aspectRatio: '16/9', maxHeight: '100%' }}>
          <SlideRenderer slide={slide} />
        </div>
      </div>
      <div style={{ padding: '0.5em 1.5em', display: 'flex', alignItems: 'center', justifyContent: 'space-between', color: 'var(--tx2, #999)', fontSize: '0.75em', borderTop: '1px solid var(--bd, #333)', background: 'var(--surf, #111)' }}>
